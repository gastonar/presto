...
public class BenchmarkTDigest
{
    ...
    public static class Digest
    {
        ...
        {
            TDigest result = new TDigest(STANDARD_COMPRESSION_FACTOR);
    ...
    {
        TDigest digest = new TDigest(STANDARD_COMPRESSION_FACTOR);
        int k = 1_000_000 / NUMBER_OF_ENTRIES;
        for (int i = 0; i < k; i++) {
    ...
    {
        TDigest copy = new TDigest(data.digest1.getCompressionFactor());
        copy.add(data.digest1);
        return copy;
    }
